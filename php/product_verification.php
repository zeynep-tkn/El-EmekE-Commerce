...
<div class="container">
        <h1>Ürün Doğrulama</h1>
        <div class="product-card">
            <div class="product-info">
                <img src="../images/seramik.jpg" alt="Ürün Görseli">
                <div>
                    <h5>Seramik Kupa</h5>
                    <p>El yapımı kupa</p>
                    <p>Fiyat: 200 TL</p>
        ...
        <div class="product-card">
            <div class="product-info">
                <img src="../images/borek.jpg" alt="Ürün Görseli">
                <div>
                    <h5>Börek-1 porsiyon</h5>
                    <p>El açması börek</p>
                    <p>Fiyat: 100 TL</p>
                </div>
            </div>
        ...
        <div class="product-card">
            <div class="product-info">
                <img src="../images/orgucanta.jpg" alt="Ürün Görseli">
                <div>
                    <h5>Örgü çanta</h5>
                    <p>kadın çanta</p>
                    <p>Fiyat: 500 TL</p>
